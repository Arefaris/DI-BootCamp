...
var render = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getEmoji()];
            case 1:
                data = _a.sent();
...
var sendGuess = function (word) { return __awaiter(_this, void 0, void 0, function () {
    var response, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("http://localhost:5000/emojis", {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    input = event.submitter;
                    return [4 /*yield*/, sendGuess(input.value)];
                case 1:
                    response = _a.sent();
