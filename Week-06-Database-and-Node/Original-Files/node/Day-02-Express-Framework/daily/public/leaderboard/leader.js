...
var _this = this;
var leadersListEl = document.querySelector(".leader-list");
var getLeaders = function () { return __awaiter(_this, void 0, void 0, function () {
    var response, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("http://localhost:5000/getleaders")];
            case 1:
                response = _a.sent();
...
var renderLeader = function () { return __awaiter(_this, void 0, void 0, function () {
    var leaders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getLeaders()];
            case 1:
                leaders = _a.sent();
